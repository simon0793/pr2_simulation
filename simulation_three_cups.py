...
class SimpleArmState:
  ...
  def isGoalState(self):
    ...
    targetX, targetY, targetZ = [0.630, 0.177,  0.775]
  ...
  def succesorState(self):
    ...
    newRightArmPose.position = RED # either update by adding to xyz offset array "+ [0, -pos_step, 0]" or assign new position, defualt keeps position the same
